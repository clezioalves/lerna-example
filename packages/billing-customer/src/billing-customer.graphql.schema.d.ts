export declare class CustomerIdentification {
    nrc?: Nullable<string>;
...
export declare class CustomerContactsInput {
    customerContact?: Nullable<Nullable<CustomerContactInput>[]>;
}
export declare class CompanyAssociationsInput {
    companyAssociation?: Nullable<Nullable<CompanyAssociationInput>[]>;
}
export declare class CompanyAssociationInput {
    nrc?: Nullable<string>;
    companyIdentification?: Nullable<string>;
    activationDate?: Nullable<string>;
}
export declare class MainDocumentInput {
    acronymType?: Nullable<string>;
    value?: Nullable<string>;
}
export declare class ContactModesValueInput {
    contactModeValue?: Nullable<Nullable<ContactModeValueInput>[]>;
}
export declare class ContactModeValueInput {
...
export declare class Fetchs {
    addressFull?: Nullable<boolean>;
}
export declare class FindAccountRequest {
    identification?: Nullable<string>;
...
export declare class FindCustomerRequest {
    companyIdentification?: Nullable<string>;
    customerIdentification?: Nullable<string>;
    personType?: Nullable<number>;
...
export declare class AddressStreet {
    name?: Nullable<string>;
    code?: Nullable<string>;
...
export declare class MainDocument {
...
export declare class SaveAccountIdentificationResponse {
    accountIdentification?: Nullable<string>;
    faultItem?: Nullable<Nullable<FaultItemResponse>[]>;
}
export declare class SaveAccountResponse {
